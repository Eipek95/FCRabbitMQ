...
namespace RabbitMQWeb.Watermark.BackgroundServices
{
    public class ImageWatermarkProcessBackgroundService : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            _channel.BasicConsume(RabbitMQClientService.QueueName, false, consumer: consumer);
        ...
        {
            //BURAYI KODLAMAYA GEREK YOK BİZ ZATEN CLIENTSERVICE TARAFINDA DISPOSE EDİYORUZ
