...
namespace FileCreateWorkerService
{
    public class Worker : BackgroundService
    {
        ...
        private readonly RabbitMQService _rabbitMQService;//signleton olduðu için direk alabildik
        private readonly IServiceProvider _serviceProvider;//datacontext scope olarak tanýmlandýðý için bu þekilde alabildik
        private IModel _channel;
        public Worker(ILogger<Worker> logger, RabbitMQService rabbitMQService, IServiceProvider serviceProvider)
        {
            _logger = logger;
        ...
        private async Task Consumer_Received(object sender, BasicDeliverEventArgs @event)
        {
            ...
            //file adý FileController (apideki) upload meyhodunun parametresi ile eþleþmeli
